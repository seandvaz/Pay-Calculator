...
(() => {
  ...
  function refreshShiftOptions(card,date,selected=''){
    const offline=card.querySelector('.offline-mode').value==='offline';
    const workedLine=card.querySelector('.worked-line').value;
    const line=offline?workedLine:current.settings.homeLine;
    ...
    card.querySelector('.worked-line-wrap').hidden=!offline;
    card.querySelector('.offline-reason-wrap').hidden=!offline;
  }
  ...
  function buildRoster(){
    ...
    current.days.forEach((row,i)=>{
      ...
      card.querySelector('.offline-mode').onchange=()=>{
        ...
        card.dataset.workedRosterLine=card.querySelector('.worked-line').value;
