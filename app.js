...
(() => {
  ...
  const defaults={baseRate:44.37,wdMult:1,satMult:1.5,sunMult:2,otMult:1.8,hdRate:4.87,maRate:4.87,nightRate:5.77,lease:546.95,gesb:100,postTax:7.40,annualLeaveLoading:20,extraTax:0};
